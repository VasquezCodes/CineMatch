      ...
      <Container className="relative z-20 -mt-16 md:-mt-32 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-[260px_1fr] lg:grid-cols-[300px_1fr] gap-8 lg:gap-12 items-start">
          ...
          <div className="w-full max-w-[200px] md:max-w-none mx-auto md:mx-0 md:sticky md:top-24 z-30">
            ...
            {movie.watchlist && (
              <div className="hidden md:flex items-center justify-center gap-2 mt-4 text-foreground/80 font-medium">
          ...
          <div className="flex flex-col space-y-6">
            <div className="space-y-4">
              ...
              {/* Metadata Secundaria (Runtime, Watchlist en Mobile) */}
              <div className="flex flex-wrap items-center gap-4 text-sm font-medium">
                ...
                {movie.watchlist && (
                  <div className="md:hidden flex items-center gap-1.5 text-foreground/80">
                    <Bookmark className="h-4 w-4 fill-current" />
                    <span>En tu lista</span>
                  </div>
                )}
        ...
        {/* 3. Secciones Inferiores (Casting, Recomendaciones) */}
